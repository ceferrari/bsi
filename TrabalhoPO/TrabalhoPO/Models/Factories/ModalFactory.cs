        ...
        public Modal criar(string tipo, Modal modal = null)
        {
            if ("Sucesso".Equals(tipo))
            {
                return new Modal()
                {
                    ...
                    IconeCabecalho = modal.IconeCabecalho ?? "glyphicon glyphicon-ok-circle",
            ...
            if ("Erro".Equals(tipo))
            {
                return new Modal()
                {
                    ...
                    IconeCabecalho = modal.IconeCabecalho ?? "glyphicon glyphicon-remove-circle",
            ...
            if ("Excluir".Equals(tipo))
            {
                return new Modal()
                {
                    ...
                    ClasseCabecalho = modal.ClasseCabecalho ?? "text-danger",
                    IconeCabecalho = modal.IconeCabecalho ?? "glyphicon glyphicon-ban-circle",
